 ...
 */
export const APP_NAME: string = "Lapu";

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = "Farcaster Mini App";
 ...
 */
export const APP_TAGS: string[] = ["social", "farcaster", "miniapp"];
 ...
 */
export const APP_SPLASH_BACKGROUND_COLOR: string = "#0066FF";
